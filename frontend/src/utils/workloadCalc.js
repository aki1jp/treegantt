...
export function calcWorkloadMatrix(tasks, min, max) {
...
export function workloadColor(count) {
    if (count === 0)
        return 'transparent';
    if (count === 1)
        return 'rgba(34,197,94,0.55)'; // green
    if (count === 2)
        return 'rgba(234,179,8,0.65)'; // yellow
    if (count === 3)
