...
export function DependencyArrow({ fromTask, toTask, minDate, zoom, taskIndex, rowHeight = ROW_HEIGHT_PX }) {
    if (!fromTask.endDate || !toTask.startDate)
        return null;
    ...
    const cx1 = x1 + 30;
    const cx2 = x2 - 30;
    return (_jsx("path", { d: `M${x1},${y1} C${cx1},${y1} ${cx2},${y2} ${x2},${y2}`, stroke: "#378ADD", strokeWidth: 1.5, fill: "none", markerEnd: "url(#arrowhead)" }));
}
